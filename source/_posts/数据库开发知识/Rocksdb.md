---
title: 【数据库开发知识】Rocksdb
date: 2020-12-29 11:16:43
categories: [数据结构, 数据库]
tags: [数据库开发知识]
---
...
![](/images/数据库/log_structured_merge_tree.png)
...
![](/images/数据库/rocksdb_read_process.png)
...
![](/images/数据库/rocksdb_mempool.png)

使用内存池时，RocksDB 的内容分配代码模块如下：

![](/images/数据库/rocksdb_mempool_arena.png)
...
![](/images/数据库/rocksdb_write_process.png)
...
![](/images/数据库/rocksdb_subcompaction.png)
...
![](/images/数据库/leveldb_manifest.jpg)
...
![](/images/数据库/leveldb_sst_file.png)
...
![](/images/数据库/leveldb_sst_block.jpg)

record 结构如下图：

![](/images/数据库/leveldb_sst_record.jpg)

Footer 结构如下图：

![](/images/数据库/leveldb_sst_footer.jpg)
...
![](/images/数据库/leveldb_versionset.png)
...
![](/images/数据库/leveldb_version_manifest.png)

新增数据正好对应于VersionEdit内容，也就是说Manifest文件记录的是一组VersionEdit值，在Manifest中的一次增量内容称作一个Block。

![](/images/数据库/leveldb_manifest_block_item.png)

Manifest Block 的详细结构如上图所示。

![](/images/数据库/leveldb_data_restore.png)
...
![](/images/数据库/rocksdb_backup_dir_list.png)
